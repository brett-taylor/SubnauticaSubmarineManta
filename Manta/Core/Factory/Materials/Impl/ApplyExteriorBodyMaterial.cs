...
namespace Manta.Core.Factory.Materials.Impl
{
    public class ApplyExteriorBodyMaterial : ApplyMaterial
    {
        ...
        protected override IEnumerable<string> MaterialTargets => new[] {"Exterior-middleBody"};
        ...
        protected override void ApplyMaterialProperties(Material material)
        {
            ...
            material.SetTexture(MaterialProperty.SPEC_TEX, Assets.HULL_THREE_SPEC_MAP);
            material.SetVector(MaterialProperty.SPEC_TEX_ST, new Vector4(1.0f, 1.0f, 0.0f, 0.0f));
            material.SetTexture(MaterialProperty.BUMP_MAP, Assets.HULL_THREE_NORMAL_MAP);
