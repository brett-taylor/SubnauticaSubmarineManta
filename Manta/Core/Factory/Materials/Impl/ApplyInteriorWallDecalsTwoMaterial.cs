...
{
    public class ApplyInteriorWallDecalsTwoMaterial : ApplyMaterial
    {
        protected override IEnumerable<string> TargetPaths => new[] {"Model/Interior/InteriorDecals"};
        protected override IEnumerable<string> MaterialTargets => new[] {"WallDecalsTwo"};
        ...
        protected override void ApplyMaterialProperties(Material material)
        {
            ...
            material.SetTexture(MaterialProperty.BUMP_MAP, Assets.WALL_DECALS_TWO_NORMAL_MAP);
            ...
            material.SetTexture(MaterialProperty.ILLUM, Assets.WALL_DECALS_TWO_EMISSIVE_MAP);
